  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="pointer-events-auto flex items-center gap-2.5 bg-neutral-950/95 hover:bg-black text-white pl-3 pr-4 py-2.5 rounded-full shadow-[0_8px_24px_rgba(0,0,0,0.3)] border border-neutral-800 hover:border-[#FFCC00] focus:outline-hidden focus:ring-2 focus:ring-[#FFCC00] focus:ring-offset-2 focus:ring-offset-neutral-900 transition-all duration-200 hover:scale-105 active:scale-95 cursor-pointer backdrop-blur-sm group"
      >
        <span className="relative flex items-center justify-center w-6 h-6 rounded-full bg-[#FFCC00] text-black shrink-0">
          <MessageSquareText className="w-3.5 h-3.5 stroke-[2.5]" />
          <span className="absolute -top-0.5 -right-0.5 w-2 h-2 rounded-full bg-[#FFCC00] animate-ping opacity-75" />
        </span>
